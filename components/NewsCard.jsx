...
const NewsCard = ({ article }) => {
  return (
    <div className="max-w-sm rounded-3xl min-h-[220px] flex flex-col overflow-hidden shadow-lg m-4 hover:shadow-2xl transition-shadow duration-300 ease-in-out bg-white dark:bg-gray-800 ">
      <img
        className="w-full h-48 object-cover"
        src={article?.urlToImage || "/ERROR_GIF.jpeg"}
        alt={article?.title}
        width={400}
        height={400}
      />
