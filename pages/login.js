  ...
  return isLoading || (!isLoading && currentUser) ? (
    ...
    <div className="flex justify-center items-center min-h-screen bg-c1">
      ...
      <div className="flex items-center flex-col w-full max-w-md p-6">
        ...
        <form onSubmit={handleSumbit} className="flex flex-col items-center gap-3 w-full">
          <input
            type="email"
            placeholder="Email"
        ...
        <div className="flex justify-center gap-1 text-c3 mt-5">
          ...
          <Link href="/register" className="font-semibold text-white underline cursor-pointer">
            Register Now
          </Link>
        </div>
      </div>
